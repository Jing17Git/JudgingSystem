...
class IndigenousAttireController extends Controller
{
    /**
     * Display the indigenous attire scoring table.
     */
    public function index(Request $request)
    {
        ...
        $scores = IndigenousAttireScore::all()->keyBy(function ($s) {
        ...
        return view('admin.indigenous_attire.index', compact(
            'judges',
            'candidates',
            'scores',
            'candidateTotals',
    ...
    public function saveScore(Request $request)
    {
        ...
        $scoreRecord = IndigenousAttireScore::updateOrCreate(
            [
        ...
        try {
            ...
            Log::warning('Broadcast failed in IndigenousAttireController: '.$e->getMessage());
        }

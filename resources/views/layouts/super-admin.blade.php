    ...
    <aside :class="sidebarOpen ? 'open' : ''" class="sidebar flex flex-col lg:translate-x-0">
        ...
        <div class="flex items-center gap-3 px-5 py-5 border-b border-[var(--border-default)]">
            ...
            <div>
                <h1 class="text-sm font-bold text-[var(--text-primary)] leading-tight flex items-center gap-1.5">
                    {{ \App\Models\SiteSetting::get('site_name', 'JudgingSystem') }}
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('super-admin.site-settings.index') }}"
               class="sidebar-link {{ request()->routeIs('super-admin.site-settings.*') ? 'active font-bold' : '' }}">
                <span class="icon text-purple-600">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('super-admin.settings.audit_record') }}"
               class="sidebar-link {{ request()->routeIs('super-admin.settings.audit_record*') ? 'active font-bold' : '' }}">
                <span class="icon text-purple-600">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('super-admin.categories.reset') }}"
               class="sidebar-link {{ request()->routeIs('super-admin.categories.reset') ? 'active font-bold' : '' }}">
                <span class="icon text-purple-600">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                    </svg>
                </span>
                Reset Categories All Data 
            </a>

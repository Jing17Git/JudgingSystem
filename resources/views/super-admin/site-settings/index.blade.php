...
@section('title', 'Site Branding & Settings - Super Admin')
...
<div class="space-y-6">
    ...
    <form action="{{ route('super-admin.site-settings.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        ...
        <div class="bg-[var(--bg-card)] border border-[var(--border-default)] rounded-2xl p-6 shadow-sm">
            <div class="flex items-center gap-3 pb-4 mb-6 border-b border-[var(--border-default)]">
                <div class="w-10 h-10 rounded-xl bg-purple-600/10 text-purple-600 flex items-center justify-center font-bold">
                    1
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="site_name" value="{{ old('site_name', $settings['site_name']->value ?? 'CrownScore') }}" required
                        class="w-full px-4 py-2.5 rounded-xl border border-[var(--border-default)] bg-[var(--bg-input)] text-[var(--text-primary)] focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all text-sm font-semibold">
                ...
                <div>
                    ...
                    <input type="text" name="site_tagline" value="{{ old('site_tagline', $settings['site_tagline']->value ?? 'Pageant Judging System') }}"
                        class="w-full px-4 py-2.5 rounded-xl border border-[var(--border-default)] bg-[var(--bg-input)] text-[var(--text-primary)] focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all text-sm">
                    <p class="text-xs text-[var(--text-muted)] mt-1">Appears under system name on landing page and logins.</p>
                </div>

                {{-- Logo Upload & Preview --}}
                <div class="md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4 items-center p-4 bg-purple-50/50 dark:bg-purple-950/20 border border-purple-100 dark:border-purple-900/30 rounded-xl">
                    <div>
                    ...
                    <div>
                        <input type="file" name="site_logo" accept="image/*" class="text-xs text-[var(--text-secondary)] file:mr-3 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-purple-600 file:text-white hover:file:bg-purple-700 cursor-pointer">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="hero_headline" rows="2"
                        class="w-full px-4 py-2.5 rounded-xl border border-[var(--border-default)] bg-[var(--bg-input)] text-[var(--text-primary)] focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all text-sm font-semibold">{{ old('hero_headline', $settings['hero_headline']->value ?? "Where Excellence\nMeets the Crown.") }}</textarea>
                ...
                <div class="md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4 items-center p-4 bg-purple-50/50 dark:bg-purple-950/20 border border-purple-100 dark:border-purple-900/30 rounded-xl">
                    ...
                    <div>
                        <input type="file" name="hero_image" accept="image/*" class="text-xs text-[var(--text-secondary)] file:mr-3 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-purple-600 file:text-white hover:file:bg-purple-700 cursor-pointer">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[var(--bg-card)] border border-[var(--border-default)] rounded-2xl p-6 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="p-4 border border-[var(--border-default)] rounded-xl space-y-3 bg-gray-50/50 dark:bg-gray-900/30">
                    <div class="flex items-center gap-2 font-bold text-sm text-purple-600">
                    ...
                    <div>
                        ...
                        <input type="text" name="feature_1_title" value="{{ old('feature_1_title', $settings['feature_1_title']->value ?? 'Real-Time Scoring') }}"
                            class="w-full px-3 py-2 rounded-lg border border-[var(--border-default)] bg-[var(--bg-input)] text-[var(--text-primary)] text-xs font-semibold focus:ring-2 focus:ring-purple-500 outline-none">
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-[var(--text-primary)] mb-1">Description</label>
                        <textarea name="feature_1_text" rows="2"
                            class="w-full px-3 py-2 rounded-lg border border-[var(--border-default)] bg-[var(--bg-input)] text-[var(--text-primary)] text-xs focus:ring-2 focus:ring-purple-500 outline-none">{{ old('feature_1_text', $settings['feature_1_text']->value ?? 'Instant, accurate results as it happens.') }}</textarea>
                    </div>
                </div>
                ...
                <div class="p-4 border border-[var(--border-default)] rounded-xl space-y-3 bg-gray-50/50 dark:bg-gray-900/30">
                    ...
                    <div>
                        ...
                        <textarea name="feature_2_text" rows="2"
                            class="w-full px-3 py-2 rounded-lg border border-[var(--border-default)] bg-[var(--bg-input)] text-[var(--text-primary)] text-xs focus:ring-2 focus:ring-purple-500 outline-none">{{ old('feature_2_text', $settings['feature_2_text']->value ?? 'Your data is safe with enterprise-grade security.') }}</textarea>
                    </div>
                </div>
                ...
                <div class="p-4 border border-[var(--border-default)] rounded-xl space-y-3 bg-gray-50/50 dark:bg-gray-900/30">
                    ...
                    <div>
                        ...
                        <textarea name="feature_3_text" rows="2"
                            class="w-full px-3 py-2 rounded-lg border border-[var(--border-default)] bg-[var(--bg-input)] text-[var(--text-primary)] text-xs focus:ring-2 focus:ring-purple-500 outline-none">{{ old('feature_3_text', $settings['feature_3_text']->value ?? 'Clear, auditable, and built for fairness.') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-4 p-4 bg-[var(--bg-card)] border border-[var(--border-default)] rounded-2xl shadow-lg sticky bottom-4 z-20">
            ...
            <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold text-sm rounded-xl shadow-md hover:shadow-purple-500/25 transition-all flex items-center gap-2">

        ...
        <form action="{{ route('admin.judges.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-input @error('name') border-[var(--danger)] @enderror" value="{{ old('name') }}" required autofocus placeholder="e.g. Juan Dela Cruz" minlength="3" maxlength="100" style="text-transform: capitalize;">
                    @error('name')

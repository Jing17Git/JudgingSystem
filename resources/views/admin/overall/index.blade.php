...
@section('title', 'Overall Tabulation')
...
<div class="page-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
        ...
        <p class="page-subtitle">Overall score breakdown across Production, Fitness, Traditional Attire, and Indigenous Attire.</p>
    </div>
            ...
            <table class="data-table min-w-full">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-200">
                        ...
                        <th class="text-center min-w-[120px] text-xs font-bold text-gray-600 uppercase tracking-wider py-3 px-4">Production</th>
                        <th class="text-center min-w-[120px] text-xs font-bold text-gray-600 uppercase tracking-wider py-3 px-4">Fitness</th>
                        <th class="text-center min-w-[150px] text-xs font-bold text-gray-600 uppercase tracking-wider py-3 px-4">Traditional Attire</th>
                        <th class="text-center min-w-[150px] text-xs font-bold text-gray-600 uppercase tracking-wider py-3 px-4">Indigenous Attire</th>
                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors">
                            ...
                            @elseif($gKey === 'Other')
                                <td class="text-center py-3 px-4" style="background-color: #faf5ff;">
                                    <span class="font-extrabold text-lg text-purple-700">
                                        {{ $total > 0 ? number_format($total, 2) : '—' }}
                                    </span>
                                </td>
                            @else
                                <td class="text-center py-3 px-4" style="background-color: #f3f4f6;">
                                    <span class="font-extrabold text-lg text-gray-700">
                                        {{ $total > 0 ? number_format($total, 2) : '—' }}
                                    </span>
                                </td>
                            @endif
...
<div class="mt-2 flex flex-wrap items-center gap-4 text-xs text-[var(--text-muted)]">
    ...
    <span>· Overall scores represent the cumulative total across Production, Fitness, Traditional Attire, and Indigenous Attire.</span>
</div>
